...
var map = new ol.Map({
    ...
    view: new ol.View({
        ...
        maxZoom: 28,
        minZoom: 1,
        extent: [458228.263395, 321819.274089, 466628.263395, 337146.205195],
        projection: new ol.proj.Projection({
            code: 'EPSG:27700',
            //extent: [460300.000000, 329300.000000, 464300.000000, 332300.000000],
            units: 'm'
        })
    })
});
...
map.getView().fit([458228.263395, 321819.274089, 466628.263395, 337146.205195], map.getSize());
